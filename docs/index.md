...
- Planification de tâches  
  crontab, Windows Task Scheduler
...
- Design
  ...
  - [Find colors that go well together](http://chir.ag/projects/name-that-color/#6195ED)
...
- Codes  
  ...
  - [Norme ISO 639-1](https://fr.wikipedia.org/wiki/Liste_des_codes_ISO_639-1) (ex: en)
  - [Norme ISO 3166-1](https://en.wikipedia.org/wiki/ISO_3166-1) (ex: GB)

- Valider des données
  - [Validateur HTML](https://validator.w3.org/)
  - [Validateur CSS](http://jigsaw.w3.org/css-validator/)
  - [Validateur JS](https://jshint.com/)
