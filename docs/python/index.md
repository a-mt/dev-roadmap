...
* [Installer / exécuter](python-install.md)
* [Introduction](python-overview.md)
* [Types de données & variables](python-types.md)
* [Opérateurs](python-operators.md)
* [Structures de contrôle / boucles](python-if.md)
* Types
  * [Nombres](python-number.md)
  * [Chaînes de caractères](python-string.md)
  * [Listes](python-list.md)
